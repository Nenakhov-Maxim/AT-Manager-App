...
class Users(models.Model):
  ...
  user_family = models.CharField('Фамилия', max_length=250)
  user_second_name = models.CharField('Отчество', max_length=250)
  user_position = models.ForeignKey('Positions', on_delete=models.CASCADE)
  
  def __str__(self):
    return f'{self.user_family} {self.user_name[0]}.{self.user_second_name[0]}. - {self.user_position}'
...
class Tasks(models.Model):
  ...
  task_time_settingUp = models.FloatField('Время на переналадку', default=0)
